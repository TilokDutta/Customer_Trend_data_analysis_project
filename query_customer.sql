...
select gender, SUM(purchase_amount) as revenue_generated from customer group by gender
...
SELECT shipping_type, ROUND(AVG(purchase_amount),2) as "Average purchase_cost"
FROM customer 
